  ...
  $sqlipd = "select * from (
    SELECT * from (
        SELECT * from (
            ...
            count(CASE WHEN LABRESULT.CHARACTER_RESULT not LIKE '%Detected' THEN OFH_LIKE.HN END) AS no_covid,
            count(CASE WHEN LABRESULT.CHARACTER_RESULT LIKE '%Detected'  THEN OFH_LIKE.HN END) AS yes_covid,
